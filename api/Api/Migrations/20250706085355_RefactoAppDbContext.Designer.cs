...
namespace Api.Migrations
{
    ...
    [Migration("20250706085355_RefactoAppDbContext")]
    partial class RefactoAppDbContext
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9e3da8cf-3451-43cd-922b-209b6db9f42f"),
                            Created = new DateTime(2025, 7, 6, 8, 53, 54, 894, DateTimeKind.Utc).AddTicks(4470),
                            PasswordHash = "$argon2id$v=19$m=16,t=2,p=1$ZEp5eWdQeDBXeGk2OWh6Qw$/sfpIugCYAcUqDG3xmx/2g",
                            Salt = new byte[] { 139, 113, 56, 188, 210, 170, 85, 70, 179, 174, 181, 11, 101, 122, 86, 16 },
            ...
            modelBuilder.Entity("Api.Entities.Vault", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f7a4597a-0293-4ef1-af45-bd9882055a35"),
                            Created = new DateTime(2025, 7, 6, 8, 53, 55, 11, DateTimeKind.Utc).AddTicks(8550),
                            Name = "Default Vault",
                            UserId = new Guid("9e3da8cf-3451-43cd-922b-209b6db9f42f")
                        });
                });
